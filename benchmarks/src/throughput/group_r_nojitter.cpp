...
AION_REGISTER(BM_R_low_nojitter_1M);
AION_REGISTER(BM_R_low_nojitter_10M);
AION_REGISTER(BM_R_low_nojitter_100M);
AION_REGISTER(BM_R_medium_nojitter_1M);
AION_REGISTER(BM_R_medium_nojitter_10M);
AION_REGISTER(BM_R_medium_nojitter_100M);
AION_REGISTER(BM_R_high_nojitter_1M);
AION_REGISTER(BM_R_high_nojitter_10M);
AION_REGISTER(BM_R_high_nojitter_100M);
